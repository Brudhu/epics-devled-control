...
epicsShareExtern long devGpioControlInit( int after );
epicsShareExtern long devGpioControlInitRecord( dbCommon *prec, devGpio_rec_t* pconf );
epicsShareExtern long devGpioControlGetIoIntInfo( int cmd, dbCommon *prec, IOSCANPVT *ppvt );
epicsShareExtern long devGpioControlRead( devGpio_info_t *pinfo );
epicsShareExtern long devGpioControlWrite( devGpio_info_t *pinfo );
